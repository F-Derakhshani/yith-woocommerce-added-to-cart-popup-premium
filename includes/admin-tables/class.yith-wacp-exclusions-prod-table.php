...
class YITH_WACP_Exclusions_Prod_Table extends WP_List_Table {
     ...
     *
     * @return \YITH_WACP_Exclusions_Prod_Table
     * @since 1.0.0
     */
    ...
    public function prepare_items() {
        ...
        if ( ! empty( $exclusions ) ) {
            ...
            $column_order = isset( $_REQUEST['orderby'] ) && in_array( $_REQUEST['orderby'], array( 'products_name', 'products_price' ) ) ? $_REQUEST['orderby'] : 'products_name';
