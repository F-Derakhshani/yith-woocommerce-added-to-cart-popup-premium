...
class YITH_WACP_Exclusions_Cat_Table extends WP_List_Table {
     ...
     *
     * @return \YITH_WACP_Exclusions_Cat_Table
     * @since 1.0.0
     */
    ...
    public function prepare_items() {
        ...
        if ( ! empty( $exclusions ) ) {
            ...
            $column_order = isset( $_REQUEST['orderby'] ) && in_array( $_REQUEST['orderby'], array( 'categories_name', 'categories_count' ) ) ? $_REQUEST['orderby'] : 'categories_name';
